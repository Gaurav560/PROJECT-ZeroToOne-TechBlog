...
<body>
	...
	<div class="d-grid align-items-center bg-primary banner-background "
...
<% 
							...
							<form action="seilet" method="post">
								...
								<div class="form-group">
									<label for="exampleInputprofession">Profession</label> <input
										type="text" class="form-control" id="exampleInputProfession"
...
<div class="container text-center ">
								<button type="submit" id="sb" class="btn btn-primary mx-4">Register</button>  
								<a href="login_page.jsp"> Login Here.</a>
								</div>
							</form>
